...
public class AdapterIndividuals extends RecyclerView.Adapter<AdapterIndividuals.viewHolder> {

    ArrayList<profilemodel> cloneArray = new ArrayList<>();
    Context contex;

    public AdapterIndividuals(ArrayList<profilemodel> cloneArray, Context contex) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(contex).inflate(R.layout.custom_view,parent,false);
